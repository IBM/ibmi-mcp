...
export class SourceManager {
  ...
  private async _performInitialization(
    ...
    try {
      ...
      logger.info(
        ...
        `Initializing connection pool for source: ${sourceName}`,
      );
    ...
    return ErrorHandler.tryCatch(
      async () => {
        ...
        logger.debug(
          ...
          `Executing SQL query on source: ${sourceName}`,
        );
        ...
        logger.debug(
          ...
          `Query executed successfully on source: ${sourceName}`,
        );
  ...
  async checkSourceHealth(
    ...
    try {
      ...
      logger.error(
        ...
        `Health check failed for source: ${sourceName}`,
      );
  ...
  async closeSource(
    ...
    try {
      ...
      logger.error(
        ...
        `Error closing connection pool for source: ${sourceName}`,
      );
    }
  }
  ...
  async closeAllSources(context?: RequestContext): Promise<void> {
    ...
    logger.info(
      ...
      "All source connection pools closed",
    );
  }
