    ...
    return ErrorHandler.tryCatch(
      async () => {
        logger.info(
          ...
          "Generating and registering all YAML tools",
        );
        ...
        logger.info(
          ...
          "All YAML tools generated and registered successfully",
        );
      },
      {
        operation: "GenerateAndRegisterAllTools",
